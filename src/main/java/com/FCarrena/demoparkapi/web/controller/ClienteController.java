...
import com.FCarrena.demoparkapi.web.dto.ClienteCreateDto;
import com.FCarrena.demoparkapi.web.dto.ClienteResponseDto;
import com.FCarrena.demoparkapi.web.dto.PageableDto;
import com.FCarrena.demoparkapi.web.dto.mapper.ClienteMapper;
...
public class ClienteController {
    ...
    public ResponseEntity <ClienteResponseDto> create(@RequestBody @Valid ClienteCreateDto dto,
                                                      @AuthenticationPrincipal JwtUserDatail userDetails){
...
@GetMapping("/detalhes")
@PreAuthorize("hasRole('CLIENT')")
public ResponseEntity<ClienteResponseDto> getDetalhes(@AuthenticationPrincipal JwtUserDatail userDetails) {
