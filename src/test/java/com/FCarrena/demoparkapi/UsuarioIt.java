package com.FCarrena.demoparkapi;
...
public class UsuarioIt {
    ...
    @Test
    public void createUsuario_ComUsernameEPassawordValidos_RetornarUsuarioCriadoComStatus201(){
                UsuarioResponseDto responseBody = testClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("anac@email.com", "123456"))
                .exchange()
                ...
                org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("anac@email.com");
